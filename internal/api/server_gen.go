...
type ServerInterface interface {
	// List all repositories from GitHub with pagination
	// (GET /api/v1/providers/github/{git-server}/repositories)
	ListGitHubRepositories(w http.ResponseWriter, r *http.Request, gitServer string)
	// Get detailed information for a specific GitHub repository
	// (GET /api/v1/providers/github/{git-server}/repositories/{id})
	GetGitHubRepository(w http.ResponseWriter, r *http.Request, gitServer string, id string)
}
...
// List all repositories from GitHub with pagination
// (GET /api/v1/providers/github/{git-server}/repositories)
func (_ Unimplemented) ListGitHubRepositories(w http.ResponseWriter, r *http.Request, gitServer string) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get detailed information for a specific GitHub repository
// (GET /api/v1/providers/github/{git-server}/repositories/{id})
func (_ Unimplemented) GetGitHubRepository(w http.ResponseWriter, r *http.Request, gitServer string, id string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) ListGitHubRepositories(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListGitHubRepositories(w, r, gitServer)
	}))
...
func (siw *ServerInterfaceWrapper) GetGitHubRepository(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetGitHubRepository(w, r, gitServer, id)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/v1/providers/github/{git-server}/repositories", wrapper.ListGitHubRepositories)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/v1/providers/github/{git-server}/repositories/{id}", wrapper.GetGitHubRepository)
	})
...
type ListGitHubRepositories404JSONResponse Error
...
type GetGitHubRepository200JSONResponse RepositoryDetails
...
// ListGitHubRepositories operation middleware
func (sh *strictHandler) ListGitHubRepositories(w http.ResponseWriter, r *http.Request, gitServer string) {
...
// GetGitHubRepository operation middleware
func (sh *strictHandler) GetGitHubRepository(w http.ResponseWriter, r *http.Request, gitServer string, id string) {
